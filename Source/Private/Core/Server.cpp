...
#define OFFSET_SERVERPLAYER_LEAVEINGAME HOOK_OFFSET(0x140761ed0)
#define OFFSET_SERVERPLAYER_DISCONNECT HOOK_OFFSET(0x14075d860)

#define OFFSET_SERVERPEER_DELETECONNECTION HOOK_OFFSET(0x140703360)
#define OFFSET_SERVERPEER_CONNECTIONFORPLAYER HOOK_OFFSET(0x140703000)

#define OFFSET_SERVERCONNECTION_DISCONNECT HOOK_OFFSET(0x1407035f0)
...
#define OFFSET_CLIENT_INIT_NETWORK HOOK_OFFSET(0x140541740)
